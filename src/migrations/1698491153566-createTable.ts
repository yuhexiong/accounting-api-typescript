...
export class CreateTable1698491153566 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE \`type\` (\`id\` varchar(20) NOT NULL COMMENT 'id', \`updatedAt\` datetime(6) NOT NULL COMMENT '修改時間' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` varchar(20) NOT NULL COMMENT '名稱', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
