...
export class CreateTable1698491153566 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE \`report\` (\`id\` bigint NOT NULL AUTO_INCREMENT COMMENT '流水號', \`data\` varchar(20) NOT NULL COMMENT '日期', \`status\` smallint NOT NULL COMMENT '狀態' DEFAULT '0', \`content\` json NOT NULL COMMENT '依分類金額' DEFAULT '{}', \`totalAmount\` bigint NOT NULL COMMENT '總金額' DEFAULT '0', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
