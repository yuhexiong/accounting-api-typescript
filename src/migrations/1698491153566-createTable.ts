...
export class CreateTable1698491153566 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE \`type\` (\`id\` varchar(20) NOT NULL COMMENT 'id', \`status\` smallint NOT NULL COMMENT '狀態' DEFAULT '0', \`name\` varchar(20) NOT NULL COMMENT '名稱', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
